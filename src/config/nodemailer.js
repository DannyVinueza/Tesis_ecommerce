...
const sendMailToUser = async (userMail, token) => {
    let info = await transporter.sendMail({
        ...
        html: `<a href="https://x62fsvc8-5000.use2.devtunnels.ms/user/confirmar/${token}">Clic para confirmar tu cuenta</a>`,
    });
...
const sendMailToRecoveryPassword = async (userMail, token) => {
    ...
    <hr>
    <a href="https://x62fsvc8-5000.use2.devtunnels.ms/user/forgot_password/${token}">Clic para reestablecer tu contraseña</a>
    <hr>
